...
import com.golosanswers.portal.utils.DateUtils;
...
public class TokenComponent {
	...
	String generateToken(String username) {
		...
		return Jwts.builder().setSubject(username).setIssuedAt(now).setExpiration(DateUtils.addMilliseconds(now, properties.getLifeTime()))
	...
	boolean isExpirationNear(String token) {
		...
		return DateUtils.addSeconds(now, properties.getRange()).after(expiration);
	}
